...
<div class="auto-container">
 <div class="sec-title">
    <h1> Miscellaneous </h1>
    <p><a href="<?php echo BASE_PATH; ?>"><i class="fa fa-home"></i></a> <span class="sep sep-1"> » </span> Miscellaneous </p>
 </div>
</div>
</section>
<!--End Page Title-->
...
<div class="auto-container">
  ...
  <form id="product_buy_form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="needs-validation" novalidate>
    <input type="hidden" name="services_name" id="services_name" value="miscellaneousinsurance">
