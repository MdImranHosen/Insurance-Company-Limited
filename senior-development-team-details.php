...
header('Location: '.BASE_PATH.'/senior-development-team');
}elseif($em_url==0) {
header('Location: '.BASE_PATH.'/senior-development-team');
}else{
$em_url = (int)$em_url;
...
<?php 
      if (class_exists('EmployerClass')) {
        ...
        if (method_exists($em, 'boardOfDirectorsUpdateById')) {
          $result = $em->boardOfDirectorsUpdateById('senior_development_team',$em_url);
         if ($result) {
...
<div class="auto-container">
 <div class="sec-title">
    ...
    <p><a href="<?php echo BASE_PATH; ?>"><i class="fa fa-home"></i></a> <span class="sep sep-1"> » </span> <a href="<?php echo BASE_PATH; ?>senior-development-team"> Senior Development Team </a> <span class="sep sep-1"> » <?php echo $em_name; ?> </span></p>
 </div>
</div>
</section>
<!--End Page Title-->
