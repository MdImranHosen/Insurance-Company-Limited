...
header('Location: '.BASE_PATH.'/senior-management-team');
}elseif($em_url==0) {
header('Location: '.BASE_PATH.'/senior-management-team');
}else{
$em_url = (int)$em_url;
...
<?php 
      if (class_exists('EmployerClass')) {
        ...
        if (method_exists($em, 'boardOfDirectorsUpdateById')) {
          $result = $em->boardOfDirectorsUpdateById('senior_management_team',$em_url);
         if ($result) {
...
<div class="auto-container">
 <div class="sec-title">
    ...
    <p><a href="<?php echo BASE_PATH; ?>"><i class="fa fa-home"></i></a> <span class="sep sep-1"> » </span> <a href="<?php echo BASE_PATH; ?>senior-management-team"> Senior Management Team </a> <span class="sep sep-1"> » <?php echo $em_name; ?> </span></p>
 </div>
</div>
</section>
<!--End Page Title-->
